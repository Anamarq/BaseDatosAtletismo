		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,"Competición añadida!");
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,"Competición Borrada!");
...
////////////////////////////////////PANEL_1/////////////////////////////////////////
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consulta="Insert into FEDERACIONES(FEDERACION,TELEFONO,WEB,LOCALIZACIÓN) values('"+textFedA.getText() +"','"+textTlf.getText()+"','"+textWeb.getText()+"','"+textLoc.getText()+"')";
				try {
					accion.update(consulta);
					JOptionPane.showMessageDialog(null,"Federación añadida!");
				}catch (SQLIntegrityConstraintViolationException e2) {
					JOptionPane.showMessageDialog(null,"Ya existe esa federación en la base de datos!"); ///
				}
				catch (SQLException e1) {
					e1.printStackTrace();
				}
		...
		btnNewButton_41.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				consulta="select atletas.licencia, atletas.Nombre, atletas.apellidos,participa.resultado  from (participa join atletas on licencia=atletas_licencia)"
						...
						+ " case when participa.pruebas_prueba='Altura' or participa.pruebas_prueba='Longitud' or participa.pruebas_prueba='Pértiga' or participa.pruebas_prueba='Triple' "
